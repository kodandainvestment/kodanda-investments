      ...
      <div style={{ position: "sticky", top: 0, height: "100vh", overflow: "hidden" }}>
        <motion.div style={{ x, display: "flex", width: `${slides.length * 100}vw`, height: "100%" }}>
          {slides.map((slide) => (
            ...
            >
              {/* Left: image only for slide 2 */}
              {slide.id === 2 && (
                <div style={{ flex: 1, height: "65vh", borderRadius: 24, overflow: "hidden", flexShrink: 0 }}>
                  <img
                    src="/about-us.png"
                    alt="About Kodanda Investments"
