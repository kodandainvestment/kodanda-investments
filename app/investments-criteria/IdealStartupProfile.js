  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-20">
      <div className="text-center mb-14">
        <span className="text-indigo-600 text-sm font-semibold tracking-widest uppercase">What We Look For</span>
        <h2 className="mt-3 text-3xl md:text-4xl font-bold text-indigo-950">Ideal Startup Profile</h2>
      ...
      <div className="grid sm:grid-cols-2 gap-8">
        {traits.map(({ Icon, title, desc }) => (
          <div key={title} className="flex gap-5 p-7 border border-indigo-100 rounded-2xl shadow-sm hover:shadow-md transition-shadow bg-white">
      ...
      <div className="mt-10 bg-indigo-50 border border-indigo-100 rounded-2xl p-8 grid sm:grid-cols-3 gap-8 text-center">
