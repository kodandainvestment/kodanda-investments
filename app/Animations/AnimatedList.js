    ...
    <div className={`relative w-[500px] ${className}`}>
      <div
        ...
        className={`max-h-[400px] overflow-y-auto p-4 ${
          displayScrollbar
            ? '[&::-webkit-scrollbar]:w-[8px] [&::-webkit-scrollbar-track]:bg-[#f0f0f0] [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[#2E2C77] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:border-[2px] [&::-webkit-scrollbar-thumb]:border-solid [&::-webkit-scrollbar-thumb]:border-[#f0f0f0]'
            : 'scrollbar-hide'
        }`}
        onScroll={handleScroll}
        style={{
          scrollbarWidth: displayScrollbar ? 'thin' : 'none',
          scrollbarColor: '#2E2C77 #f0f0f0'
        }}
      >
        {items.map((item, index) => (
          ...
          >
            <div className={`${itemClassName || `p-4 bg-[#111] rounded-lg ${selectedIndex === index ? 'bg-[#222]' : ''}`}`}>
